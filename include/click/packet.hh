...
class Packet { public:
    ...
    inline void set_label_header(const click_label *lh, uint32_t len);
 ...
 * */
inline void
Packet::set_label_header(const click_label *lh, uint32_t len)
{
    set_network_header(reinterpret_cast<const unsigned char *>(lh), len);
}
